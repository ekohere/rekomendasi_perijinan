 ...
 */
(function(e){if(typeof d.define==="function"&&d.define.amd){d.define("jquery-mousewheel",["jquery"],e)}else{if(typeof exports==="object"){module.exports=e}else{e(a)}}}(function(e){var p=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],o=("onwheel" in document||document.documentMode>=9)?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],m=Array.prototype.slice,k,h;if(e.event.fixHooks){for(var g=p.length;g;){e.event.fixHooks[p[--g]]=e.event.mouseHooks}}var n=e.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener){for(var q=o.length;q;){this.addEventListener(o[--q],f,false)}}else{this.onmousewheel=f}e.data(this,"mousewheel-line-height",n.getLineHeight(this));e.data(this,"mousewheel-page-height",n.getPageHeight(this))},teardown:function(){if(this.removeEventListener){for(var q=o.length;q;){this.removeEventListener(o[--q],f,false)}}else{this.onmousewheel=null}e.removeData(this,"mousewheel-line-height");e.removeData(this,"mousewheel-page-height")},getLineHeight:function(r){var i=e(r),q=i["offsetParent" in e.fn?"offsetParent":"parent"]();if(!q.length){q=e("body")}return parseInt(q.css("fontSize"),10)||parseInt(i.css("fontSize"),10)||16},getPageHeight:function(i){return e(i).height()},settings:{adjustOldDeltas:true,normalizeOffset:true}};e.fn.extend({mousewheel:function(i){return i?this.bind("mousewheel",i):this.trigger("mousewheel")},unmousewheel:function(i){return this.unbind("mousewheel",i)}});function f(v){var z=v||window.event,q=m.call(arguments,1),s=0,t=0,u=0,i=0,x=0,y=0;v=e.event.fix(z);v.type="mousewheel";if("detail" in z){u=z.detail*-1}if("wheelDelta" in z){u=z.wheelDelta}if("wheelDeltaY" in z){u=z.wheelDeltaY}if("wheelDeltaX" in z){t=z.wheelDeltaX*-1}if("axis" in z&&z.axis===z.HORIZONTAL_AXIS){t=u*-1;u=0}s=u===0?t:u;if("deltaY" in z){u=z.deltaY*-1;s=u}if("deltaX" in z){t=z.deltaX;if(u===0){s=t*-1}}if(u===0&&t===0){return}if(z.deltaMode===1){var w=e.data(this,"mousewheel-line-height");s*=w;u*=w;t*=w}else{if(z.deltaMode===2){var A=e.data(this,"mousewheel-page-height");s*=A;u*=A;t*=A}}i=Math.max(Math.abs(u),Math.abs(t));if(!h||i<h){h=i;if(l(z,i)){h/=40}}if(l(z,i)){s/=40;t/=40;u/=40}s=Math[s>=1?"floor":"ceil"](s/h);t=Math[t>=1?"floor":"ceil"](t/h);u=Math[u>=1?"floor":"ceil"](u/h);if(n.settings.normalizeOffset&&this.getBoundingClientRect){var r=this.getBoundingClientRect();x=v.clientX-r.left;y=v.clientY-r.top}v.deltaX=t;v.deltaY=u;v.deltaFactor=h;v.offsetX=x;v.offsetY=y;v.deltaMode=0;q.unshift(v,s,t,u);if(k){clearTimeout(k)}k=setTimeout(j,200);return(e.event.dispatch||e.event.handle).apply(this,q)}function j(){h=null}function l(q,i){return n.settings.adjustOldDeltas&&q.type==="mousewheel"&&i%120===0}}));d.define("jquery.select2",["jquery","jquery-mousewheel","./select2/core","./select2/defaults"],function(e,f,h,g){if(e.fn.select2==null){var i=["open","close","destroy"];e.fn.select2=function(k){k=k||{};if(typeof k==="object"){this.each(function(){var n=e.extend(true,{},k);var m=new h(e(this),n)});return this}else{if(typeof k==="string"){var l;var j=Array.prototype.slice.call(arguments,1);this.each(function(){var m=e(this).data("select2");if(m==null&&window.console&&console.error){console.error("The select2('"+k+"') method was called on an element that is not using Select2.")}l=m[k].apply(m,j)});if(e.inArray(k,i)>-1){return this}return l}else{throw new Error("Invalid arguments for Select2: "+k)}}}}if(e.fn.select2.defaults==null){e.fn.select2.defaults=g}return h});return{define:d.define,require:d.require}}());var c=b.require("jquery.select2");a.fn.select2.amd=b;return c}));